...
public class OpenCVLoader {
    ...
    public static boolean initDebug(Context context) {
        return StaticHelper.initOpenCV(context);//initDebug(context, false);
    }
...
//     * @return Returns true is initialization of OpenCV was successful.
//     */
//    private static boolean initDebug(Context context, boolean InitCuda) {
//        return StaticHelper.initOpenCV(context, InitCuda);
//    }
