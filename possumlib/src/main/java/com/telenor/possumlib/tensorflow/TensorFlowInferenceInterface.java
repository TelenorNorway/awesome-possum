...
package com.telenor.possumlib.tensorflow;
...
public class TensorFlowInferenceInterface {
    private static final String tag = TensorFlowInferenceInterface.class.getName();
    ...
    public boolean initialize(Context context) throws Exception {
        ...
        try {
            ...
            try {
                ReLinker.loadLibrary(context, "tensorflow_inference");
            } catch (Exception e) {
                Log.i(tag, "Failed to load tensorflow:",e);
                return false;
            }
        }
        return true;
    ...
    /**
     * Get tensorflow output weights for an inputted image
     */
    public native float[] getWeights(int[] rgb_array);
